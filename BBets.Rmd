...
To  make the game fair Brownlow should pay out `r 
mean(saveBank)` 
...
To make the game fair Brownlow class size should have `r numClass` students

<!--Explain and display the results of your method of coming up with the estimate of professor Brownlows betting profits!-->


## Question 3 - Expected Profits
...
Brownlow is expected to make a profit of `r mean(saveBank)`

# Discussion and Conclusion

<!--Discussion and conclusion here.  If professor Brownlow is consistantly making or losing money how could he change his payout so that his profits center on zero?  Also discuss what size his class should be in order to have his current scheme balance at zero profit.!-->

With a class size of 35 with odds if 2 professer is making a profit about $280. So Brownlow should have class size of 28 to have his scheme balance at zero. The odds ratio is 4 will also zero out the profits.  
